...
export const colorOptions = [
  ...
  },
  {
    ...
    label: 'Rose',
    class: {
      base: 'bg-rose-500 border-rose-500 bg-rose-500/10 hover:bg-rose-500/20 text-rose-500',
      light: 'bg-rose-300 border-rose-300 bg-rose-300/10 text-rose-300',
      dark: 'dark:bg-rose-700 dark:border-rose-700 bg-rose-700/10 text-rose-700',
    },
  },
  {
    value: 'gray',
