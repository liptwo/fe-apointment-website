...
export const metadata = {
  ...
  description: "Create your MediCare account to start managing medical appointments",
}
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-primary-foreground/80 max-w-md">
              Whether you&apos;re a patient seeking care or a provider offering services, MediCare connects you.
            </p>
          </div>
